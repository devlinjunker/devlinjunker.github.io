...
})({"73nci":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "10265c1da216fb1d";
"use strict";
...
},{}],"2ojzv":[function(require,module,exports,__globalThis) {
...
window.MicroModal = (0, _micromodalDefault.default);
window.openModal = function(position) {
    [
        ...document.getElementsByClassName('job-details')
    ].forEach((element)=>{
        element.classList.add('hidden');
    });
    document.getElementById(`${position}-modal-content`).classList.remove('hidden');
    (0, _micromodalDefault.default).show('career-modal');
};

},{"micromodal":"cjhRo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cjhRo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["73nci","2ojzv"], "2ojzv", "parcelRequire94c2")

//# sourceMappingURL=career.a216fb1d.js.map
